      ...
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            ...
            paragraph="Pathwise helps students build strong, global-ready college applications. We guide them through original research, real-world software projects, and focused test prep—so they apply with work that stands out and scores that prove it."
            center
            mb="80px"
          />
        </div>
